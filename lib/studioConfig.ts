...
export const STUDIO_TABLES: Record<StudioTableKey, StudioTable> = {
  ...
  issues: {
    ...
    fields: [
      ...
      { key: "customText", field: "Quick Hits - Custom Text", label: "Extra line: text", kind: "text", placeholder: "Want to rep A&D? Road & Trail Crew applications are open", help: "Optional. Shows after the vlogs. Needs a link too." },
      { key: "customUrl", field: "Quick Hits - Custom URL", label: "Extra line: link", kind: "url", placeholder: "https://www.asphaltanddirt.com/ambassadors" },
      { key: "customButton", field: "Quick Hits - Custom Button", label: "Extra line: button word", kind: "text", placeholder: "Apply", help: "Blank: \"Check It Out\"." },
      { key: "custom2Text", field: "Quick Hits - Custom 2 Text", label: "Second extra line: text", kind: "text", placeholder: "Got a rig worth showing? Submit your build to be featured" },
      { key: "custom2Url", field: "Quick Hits - Custom 2 URL", label: "Second extra line: link", kind: "url", placeholder: "https://www.asphaltanddirt.com/builds/submit" },
      { key: "custom2Button", field: "Quick Hits - Custom 2 Button", label: "Second extra line: button word", kind: "text", placeholder: "Submit" },

...
export const builds: Build[] = [
  ...
  },
  {
    ...
    stats: [
      { value: "285 HP", unit: "3.6L Pentastar V6", icon: "bolt" },
      { value: "37\"", unit: "Nitto Trail Grappler", icon: "compass" },
      { value: "4.5\"", unit: "MetalCloak Lift", icon: "lift" },
    ],
    listingImage: { src: "/img/builds/iron-bandit.jpg", alt: "Iron Bandit, Dan's Jeep Wrangler JK, plowing through a sandy trail" },
    heroImage: { src: "/img/builds/iron-bandit-hero.jpg", alt: "Iron Bandit, Dan's Jeep Wrangler JK, flexed out on a rock ledge in the woods" },
    listingSpecs: [
      { label: "Engine", value: "3.6L Pentastar V6" },
      { label: "Suspension", value: "MetalCloak 4.5\" Game Changer" },
      { label: "Wheels & Tires", value: "37\" Nitto Trail Grappler on 17\" ATX Slabs" },
      { label: "Armor & Extras", value: "Full Skids, Bestop Trektop, XRC 9500 Winch" },
    ],
    specs: [
      { label: "Base Vehicle", value: "2012 Jeep Wrangler JK Sport (2-Door)", icon: "vehicle" },
      { label: "Engine", value: "3.6L Pentastar V6 (285 HP) — TrailDash tune, Airaid intake, upgraded throttle body", icon: "bolt" },
      { label: "Suspension", value: "MetalCloak 4.5\" Game Changer w/ drop brackets, G2 Core 44 front axle (35-spline, Auburn E-locker), Reid Racing knuckles", icon: "lift" },
      { label: "Wheels & Tires", value: "37\" Nitto Trail Grappler on 17\" ATX Slabs", icon: "compass" },
      { label: "Armor & Extras", value: "Full belly skids, Bestop Trektop, 1300W stereo, Smittybilt XRC 9500 winch", icon: "cross" },
    ],
    aboutText:
      "Iron Bandit started life as a bone-stock 2012 JK Sport. Dan bought it in 2013, spent two years researching exactly what he wanted, then sent it to Globex Performance in 2015 to build it out — a MetalCloak 4.5\" Game Changer lift, a G2 Core 44 front axle, and 37-inch Nitto Trail Grapplers on 17\" ATX Slabs. It's built to do it all: rock crawling and bombing down rough trails on the weekend, and just as comfortable on the ride home, whether that's 5 miles or 250.",
    aboutStats: [
      { label: "Primary Terrain", value: "Rock Crawling & Trails", icon: "cross" },
      { label: "Build Goal", value: "Do-It-All Trail Capability", icon: "bolt" },
    ],
    gallery: [
      { src: "/img/builds/iron-bandit.jpg", alt: "Iron Bandit plowing through a sandy trail, dust flying" },
      { src: "/img/builds/iron-bandit-gallery-2.jpg", alt: "Iron Bandit flexed hard on a steep off-camber trail" },
      { src: "/img/builds/iron-bandit-gallery-3.jpg", alt: "Iron Bandit before and after the build" },
      { src: "/img/builds/iron-bandit-hero.jpg", alt: "Iron Bandit flexed out on a rock ledge in the woods" },
    ],
  },
  {
    slug: "shockwave",
